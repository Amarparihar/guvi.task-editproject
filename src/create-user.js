...
function Createuser() {
  ...
  let userData = {
    userName,userEmail,userPAddress,userCAddress,userMobileNo,userAlternateNo
  }
  return (
    <>
      <form onSubmit={(e)=>{
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-lg-6">
            ...
            value={userAlternateNo} onChange={(e)=>{
